...
<body class="sub_page">
  ...
  <div class="hero_area">
    ...
    <!-- end header section -->
     ...
     <!-- Sección de tarjetas para opciones -->
  <section class="book_section layout_padding">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="Inf_usuarios.jsp" class="btn btn-warning">Ver Usuarios</a>
            </div>
          </div>
        </div>
        <!-- Tarjeta para PQRS -->
        <div class="col-md-6 mb-4">
          <div class="card">
            <img src="images/pqrs1.jpg" class="card-img-top" alt="PQRS Image">
            <div class="card-body">
              <h5 class="card-title">PQRS</h5>
              <p class="card-text">Administra las PQRS de la plataforma.</p>
              <a href="Inf_pqrs.jsp" class="btn btn-warning">Ver PQRS</a>
            </div>
          </div>
        </div>
      </div>
